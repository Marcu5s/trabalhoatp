...
<!--LIVEDEMO_00 -->
     ...
     <script src="<?php echo Controller::Assets() ?>js/jquery.equalheights.js"></script>
     <script src="<?php echo Controller::Assets() ?>js/jquery.mobilemenu.js"></script>
     <script src="<?php echo Controller::Assets() ?>js/jquery.easing.1.3.js"></script>
     <script src="<?php echo Controller::Assets() ?>js/jquery.carouFredSel-6.1.0-packed.js"></script>
     <script src="<?php echo Controller::Assets() ?>js/jquery.touchSwipe.min.js"></script>
